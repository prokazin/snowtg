...
const defaultProducts = [
    ...
    },
    {
        ...
        desc: 'Профессиональная заточка кантов сноуборда. Восстанавливаем геометрию кантов, убираем заусенцы. Подходит для всех типов досок.',
        specs: [
    ...
    },
    {
        ...
        desc: 'Профессиональная смазка скользящей поверхности. Используем качественные смазки для разных температур. Улучшаем скольжение на 30%.',
        specs: [
    ...
    },
    {
        ...
        desc: 'Ремонт повреждений скользящей поверхности. Заделываем царапины, сколы и глубокие повреждения. Восстанавливаем геометрию доски.',
        specs: [
    ...
    },
    {
        ...
        desc: 'Профессиональная установка и настройка креплений. Подбираем оптимальное положение под ваш стиль катания и размер ботинка.',
        specs: [
    ...
    },
    {
        ...
        desc: 'Полное техническое обслуживание сноуборда. Включает заточку кантов, смазку скользяка, ремонт повреждений, проверку креплений и настройку.',
        specs: [
    ...
    },
    {
        ...
        desc: 'Полная диагностика состояния сноуборда. Проверяем геометрию, состояние кантов, скользяка, креплений. Даем рекомендации по обслуживанию.',
        specs: [
